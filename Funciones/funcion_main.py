...
dataset=pd.read_parquet('Datos Limpios/full_data.parquet')
df_developer=pd.read_parquet('Datos Limpios/steam_games.parquet')
...
#Funcion 5
df_5=pd.read_parquet('Datos varios/criterio_3.parquet')
